...
public class StringUtil {
     ...
     * @return 变量名
     */
    public static String setMethodToVariable(String name) {
        return toLowerCaseFirstOne(name.substring(3));
    }

    /**
     * 用来分析类名的,遇到大写就认为是首字母,切割一次,并转为小写
     *
     * @param name 需要分析的字符串
     * @return 全小写的数组
     */
    public static List split(String name) {
